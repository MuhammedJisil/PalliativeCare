  ...
  >
    <div className="flex justify-between items-start">
      ...
      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
        assignment.status.toLowerCase() === 'active' ? 'bg-teal-100 text-teal-800' :
        assignment.status.toLowerCase() === 'completed' ? 'bg-green-100 text-green-800' :
    ...
    <div className="mt-3 ml-12 space-y-1 text-sm text-gray-600">
